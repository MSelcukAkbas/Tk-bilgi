...
def giris_yap():
    import random  # pythton çalışma zamanlı bir dil diye bunu buraya koydum , performansa etki edermi bilemem
    pencere = tk.Tk()
    ...
    şehirler = ["Kastamonu", "İstanbul", "Ankara", "İzmir", "Adana", "Adıyaman", "Afyonkarahisar", "Ağrı", "Amasya", "Antalya", "Artvin", "Aydın", "Balıkesir",
                ...
                "Yalova", "Yozgat", "Zonguldak"]
                                        # values liste kutusunda görüntülenecek listenin belirtir.
