...
# TKBK_Newgen v4.03 de pacler üzerinde düzenleme yapıldı ve programın genel satır sayısında azalma sağlandı 
        # pack işlemini direkt label ve combobox gibi işlemlerin yanında kullanılıyormuş. entrylerde hataya neden oluyor ,get() çalışmıyor 
