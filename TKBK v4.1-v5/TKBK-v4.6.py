...
def güncellemeler():
    ...
    text_box.insert(tk.END, "   v1 sürümü daha basit bir kod mantığı ile çalışıyor"
                            ...
                            "\n   TKBK_NewGen v4.06 da temizlik yapıldı ve önceki kayıtları okuma özelliği geldi"
                    )
...
def giris_yap():
    ...
    pencere_menü = tk.Menu(menü_cubuğu , tearoff=0 ,bg=arka_plan_rengi)
    ...
    pencere_menü.add_command(label="Kayıtlar", command=kayıtlar)
