    ...
    def kayıt_oluştur():
        ...
        def ortalama_hesabı():
            ...
            if dersadı == "Temel bilgi teknolojileri":
                ...
                final_oran =50
                ödev_oran = 0
            toplam_dersnotu=(dersnotu_vize * vize_oran) +  (dersnotu_final*final_oran)+ (ödev_oran*ödev_oran)
            ortalama=toplam_dersnotu/100
            messagebox.showinfo("Ortalama Hesaplanıyor...","Lütfen bekleyiniz") ###########
            time.sleep(3)
            messagebox.showinfo("Ortalamanız","Girişiminiz: {:.2f}".format(ortalama)) #######
