...
from TEK_Pack.tek_pack import kullanici_bilgileri , güncellemelerbilgiders ,dersler ,sifre_kontrol
######
    ...
    def kayıt_oluştur():
        ...
        def ortalama_hesabı():
            ...
            if dersadı == "Programlama ve Algoritma" :
                ...
                ödev_oran = 0
                ödev_durumu = "yok"
            #toplam ders notu          100 * 40 = 400   +             100 * 50  =500 
            toplam_dersnotu=(dersnotu_vize * vize_oran) +  (dersnotu_final*final_oran)
            ortalama=toplam_dersnotu/100                         #900 / 10 =  90
            ortalama= ortalama + (ödev_oran*1) # 10*1= 10 ----   90  + 10 =  100 yada 90+0 = 90
            sonuçtext = (f"{isim} Adlı kişi kaydedildi\nOrtalaması = {ortalama}")
            messagebox.showinfo("kayıt",sonuçtext) #######
