...
from TEK_Pack.tek_pack import kullanici_bilgileri , güncellemelerbilgiders ,güncellemelerbilgiders_güncel ,dersler ,sifre_kontrol
######
...
####### güncellemeler hakkında bilgi veren text box Ve penceresi #################################
...
def güncellemeler():
    ...
    güncelleme_menü = tk.Menu(menü_cubuğu , tearoff=0 ,bg=menü_rengi)
